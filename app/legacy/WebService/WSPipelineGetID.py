...
def getID_pipelines(bifrost_instance: str, headlessPar: bool):
    ...
    with sync_playwright() as p:
        ...
        for pipelineName in pipelineNames:
                pipelineName, pipelineID, schedule = getPipelineID(pipelineName, page)
                pipeDict = {"pipeline_name": pipelineName, "pipeline_id": pipelineID, "schedule": schedule}
